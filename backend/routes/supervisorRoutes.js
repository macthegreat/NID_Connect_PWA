...
import { createAgent, createOfficer, createSupervisor, listTeam, reports, updateAgentCommission } from '../controllers/supervisorController.js';
import { requireAuth } from '../middleware/auth.js';
import { requireRole } from '../middleware/role.js';
import { validateCommissionUpdate, validateCreateAgent, validateCreateOfficer, validateCreateSupervisor } from '../middleware/validate.js';
import { asyncHandler } from '../utils/errors.js';

const router = Router();

router.use(requireAuth, requireRole('supervisor'));
router.post('/create-supervisor', validateCreateSupervisor, asyncHandler(createSupervisor));
